...
library(here) ; library(agricolae) ; library(lubridate) ; library(tidyverse) 
library(ggplot2) ; library(plyr)
LakeData <- read.csv(here("Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv"), stringsAsFactors = TRUE)
